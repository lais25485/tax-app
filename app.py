...
# --- 4. 基礎データ定義（令和8年度・7年度大綱、首相官邸資料に基づく） ---
YEAR = 2026
WALL_DETAILS = {
...
st.sidebar.markdown(
    f'<a href="{support_url}" target="_blank" style="text-decoration:none;"><div style="background-color:#FFDD00;color:black;padding:0.5rem;border-radius:5px;text-align:center;font-weight:bold;">☕ コーヒーをおごる</div></a>',
    unsafe_allow_html=True
)
...
1. **所得税の壁（178万円）**: 令和8年度税制改正大綱により、所得税の非課税枠が特例的に引き上げられました。
2. **扶養の壁（136万円）**: 扶養親族の所得要件が62万円に緩和されました。
3. **社会保険の壁（時期未定）**: 106万円の壁は将来的に廃止方針ですが、撤廃時期は未定です。
---
*※本ツールは令和8年度・7年度税制改正大綱、首相官邸資料、MUFG資料に基づき作成されています。*
""")
